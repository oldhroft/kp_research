...
class SkLearnModels:
    ...
    def rf_xgboost():
        return make_pipeline(
            SelectFromModel(RandomForestClassifier(random_state=17)), XGBClassifier()
        )
    ...
    def smote_randomforest():
        return make_pipeline_imb(SMOTE(), RandomForestClassifier())

    def smote_xgboost():
        return make_pipeline_imb(SMOTE(), XGBClassifier())

    def smote_ridge():
        return make_pipeline_imb(SMOTE(), StandardScaler(), RidgeClassifier())
